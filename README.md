...
**Built from the IIM Ahmedabad "Strategy & Game Theory for Management" curriculum**

An interactive game theory simulator implementing core concepts from the Coursera course by Prof. Viswanath Pingali, IIM Ahmedabad (Certificate: Feb 2026).

## What's implemented

### 2×2 Normal-Form Games
- Prisoner's Dilemma, Battle of the Sexes, Stag Hunt, Chicken / Hawk-Dove
